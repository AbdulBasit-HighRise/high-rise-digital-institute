...
export default function Footer() {
  return (
    <footer className="relative w-full bg-[#111827] overflow-hidden pt-20 pb-8 border-t border-white/10">
      ...
      {/* WIDTH AND SCREEN RESPONSIVENESS MATRIX */}
      <div className="w-full max-w-[92%] xl:max-w-[88%] 2xl:max-w-[82%] 3xl:max-w-[75%] mx-auto px-4 sm:px-6 space-y-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-10 md:gap-8 pb-16 border-b border-white/5">
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <div className="flex items-center gap-2.5 pt-1">
              {/* Fixed Closing Tag Below from </div> to </a> */}
              <a href="https://www.facebook.com/Highrisedigitalskills/" className="w-9 h-9 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center text-zinc-400 hover:bg-blue-600 hover:text-white hover:border-blue-600 hover:-translate-y-1 transition-all duration-200">
              ...
              <a href="https://www.instagram.com/highrisedigitalskills/" className="w-9 h-9 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center text-zinc-400 hover:bg-pink-600 hover:text-white hover:border-pink-600 hover:-translate-y-1 transition-all duration-200">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between text-center sm:text-left gap-4 text-[10px] font-bold uppercase text-white font-mono w-full">
